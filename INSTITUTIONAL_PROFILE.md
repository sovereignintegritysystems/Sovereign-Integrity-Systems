...
- no customer, contract, award, certification or independent-validation claim is inferred from proposals, research activity or source development.
...
SIS distinguishes at least the following states:

**source ≠ execution ≠ integration ≠ effectiveness ≠ independent validation ≠ certification**.

Likewise:

- a proposal is not an award;
- a standards map is not certification;
