...
It exists to present public-safe company identity, public technical and research material, public program descriptions, externally releasable documentation, announcements, engagement material, and other artifacts that have been explicitly cleared for public disclosure.

It is **not** the semantic authority for internal company truth, engineering state, research state, legal state, financial state, customer state, certification state, or operational evidence.
...
## Public use of this repository

Use this repository as the stable public GitHub landing point for SIS material that has crossed the public-release boundary. When a public artifact points to deeper evidence, the cited evidence remains controlling for the exact claim it supports.
